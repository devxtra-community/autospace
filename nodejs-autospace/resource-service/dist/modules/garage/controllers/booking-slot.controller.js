...
exports.listSlotsByGarage = exports.freeSlot = exports.occupySlot = exports.releaseSlot = exports.lockSlot = exports.getSingleSlotStatus = exports.getAvailableSlots = void 0;
...
const getSingleSlotStatus = async (req, res) => {
    try {
...
exports.getSingleSlotStatus = getSingleSlotStatus;
const lockSlot = async (req, res) => {
    try {
        const slotId = String(req.params.slotId);
        const result = await slotRepo.query(`UPDATE garage_slots
       SET status = 'RESERVED'
...
const listSlotsByGarage = async (req, res) => {
    try {
...
exports.listSlotsByGarage = listSlotsByGarage;
